...
export const updateMicButton = (micActive)=>{
    const micButtonsImage = document.getElementById('mic_button_image');
    micButtonsImage.src = micActive ? micOffImgSrc : micOnImgSrc;
}
...
export const updateCameraButton = (cameraActive)=>{
    const cameraButtonsImage = document.getElementById('camera_button_image');
    cameraButtonsImage.src = cameraActive ? cameraOffImgSrc : cameraOnImgSrc;
}
...
export const showRecordingPanel = ()=>{
    ...
    const startRecording = document.getElementById('start_recording_button');
